...
const COMANDOS = [
  ...
  { grupo: '🛠️ Administração', cmd: 'mensagem', desc: 'Publica uma mensagem simples em qualquer canal.', admin: true },
  { grupo: '🛠️ Administração', cmd: 'lock', desc: 'Bloqueia um canal para membros comuns.', admin: true },
  { grupo: '🛠️ Administração', cmd: 'unlock', desc: 'Desbloqueia um canal restaurando permissões.', admin: true },
