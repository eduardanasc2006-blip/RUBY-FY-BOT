...
const PAGINAS = {
  ...
  compras: () => ({
    ...
    descricao: [
      ...
      '',
      '`🛒 Ver carrinho` mostra os itens, o total e os controles:',
      '`🎁 Escolher mais produtos` · `🗑️ Remover item` · `🧹 Limpar carrinho` · `✅ Finalizar compra`.',
      '',
      ...
      '',
      '➜ **/logcompras (adm)**',
      '*Configura o canal donde ficam os logs das compras (pedido criado, confirmado e cancelado).*',
      '',
      '➜ **/proof (adm)**',
  ...
  admin: () => ({
    ...
    descricao: [
      ...
      '',
      '➜ **/logcompras (adm)**',
      '*Define o canal onde ficam os logs das compras (pedido criado, confirmado e cancelado, alem das metas).*',
      '',
      '➜ **!embed (adm)**',
