...
async function handleModule(interaction, moduleName, openFn) {
  ...
  // Acknowledge o botão sem modificar a mensagem do painel
  ...
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '🔗 Conexões Ativas',   value: String(activeConns),        inline: true },
...
function buildPainelPayload() {
  ...
  // Linha 1 — Embeds, Modelos, Conexões, Tickets
  ...
  // Linha 2 — Pedidos, Clientes, Provas, Stats, Fechar
