...
export const comandos = [
  ...
  { cmd: '!ppt',             desc: 'Pedra, papel ou tesoura contra o bot.' },
  { cmd: '!roleta',          desc: 'Sorteia um membro aleatório.' },
  { cmd: '!escolher <ops>',  desc: 'Escolhe entre opções separadas por espaço.' },
  { cmd: '!sortear',         desc: 'Sorteia um membro online.' },
  { cmd: '!verdade',         desc: 'Pergunta de verdade aleatória.' },
  { cmd: '!desafio',         desc: 'Desafio aleatório.' },
];
