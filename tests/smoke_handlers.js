...
async function testarInteracoes() {
  ...
  const casos = [
    ...
    ["button", "estfixo:prevcat:0"],
    ["button", "estfixo:nextcat:1"],
    ["button", "estfixo:pprev:xxx:0"],
    ["button", "estfixo:pnext:xxx:1"],
    ...
    ["modal", "autoresp:addmodal:canais", { campos: { palavra: "TesteCanais", resposta: "Resposta canais no modal" } }],
    ["channelSelect", "autoresp:pickcanais", { valores: [canal.id] }],
    ["modal", "autoresp:addmodal:canais", { campos: { palavra: "TesteChan", resposta: "Resposta sem canais" } }],
    ["button", "autoresp:picksalvar"],
    ["button", "autoresp:voltar"],
    ["select", "autoresp:canalrapido", { valores: [canal.id] }],
    ["button", "autoresp:canalrapido:todos"],
    ["button", "autoresp:canalrapido:limpar"],
